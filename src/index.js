...
<li class="todo">
  <article>
      <input class="toggle" type="checkbox" value="" tabindex="0">

      <div class="view">
          <label class="label" tabindex="0">Double-tap to edit</label>
          <textarea class="edit chromeless-input"  maxlength="255">Double-tap to edit</textarea>
      </div>
      ...
      <svg class="move" width="24px" height="24px" viewBox="0 0 24 24" id="three-dots" xmlns="http://www.w3.org/2000/svg">
