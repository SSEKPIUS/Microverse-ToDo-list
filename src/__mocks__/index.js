...
function createDestroy(document) {
    const span = document.createElement('span');
...
function createView(el, document) {
...
function createInputCheckbox(el, document) {
...
function addChildrenToArticle(el, article, document) {
    article.appendChild(createInputCheckbox(el, document));
    article.appendChild(createView(el, document));
    article.appendChild(createDestroy(document));
    article.appendChild(createMove(document));
    return article;
}

function createListItem(el, document) {
    const div = document.createElement('div');
    div.classList.add('shadow');
    const li = document.createElement('li');
    li.classList.add('todo', el.completed ? 'completed' : null);
    let article = document.createElement('article');
    article = addChildrenToArticle(el, article, document);
    li.appendChild(div);
...
function loadList(window, readStorage) {
